...
foundations.question_set_version = packet.package_version;
...
researchQuestions.question_set_version = packet.package_version;
researchQuestions.corpus_version = packet.corpus_edition;
...
mappingOverrides.mapping_version = packet.package_version;
