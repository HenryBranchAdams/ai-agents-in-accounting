...
test('local construction completion preserves evidence boundaries and actionable retrieval paths',()=>{
 ...
 const a=read('data/coverage/assessments.json').assessments.find(row=>row.id==='coverage-construction-local-2026-09-14');
 assert.ok(a, 'The specifically scoped construction assessment must remain present');
