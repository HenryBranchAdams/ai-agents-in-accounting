...
const snapshots = readSnapshotHistory();
...
test("AA-I102 and AA-I103 preserve scope, source boundaries, and additive history", () => {
  ...
  assert.equal(packageRecord.package_version, "2026-09-18.102103");
  ...
  assert.equal(guide.data.version, packageRecord.package_version);
