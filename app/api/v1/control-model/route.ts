...
export async function GET(request: Request) {
  ...
  return publicResponse(
    ...
    JSON.stringify({
      ...
      collection: "control_model",
      rights_notice: rightsNotice,
      links: {
        self: `${siteOrigin}/api/v1/control-model`,
        human: `${siteOrigin}/control-model`,
        markdown: `${siteOrigin}/control-model.md`,
        workflows: `${siteOrigin}/api/v1/workflows?limit=60`,
        openapi: `${siteOrigin}/openapi.json`,
      },
      item: accountingAgentControlModel,
    }, null, 2),
