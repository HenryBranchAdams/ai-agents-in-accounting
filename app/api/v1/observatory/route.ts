...
export async function GET(request: Request) {
  ...
  return publicResponse(
    ...
    JSON.stringify({
      ...
      collection: "accounting_agents_practice_observatory",
      rights_notice: rightsNotice,
      links: {
        self: `${siteOrigin}/api/v1/observatory`,
        human: `${siteOrigin}/observatory`,
        markdown: `${siteOrigin}/observatory.md`,
        reading_room: `${siteOrigin}/reading-room`,
        source_library: `${siteOrigin}/resources`,
        current_development_resources: `${siteOrigin}/api/v1/resources?time_role=current-development&limit=200`,
      },
      item: accountingAgentsPracticeObservatory,
    }, null, 2),
