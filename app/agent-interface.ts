...
export function buildAgentContextMarkdown() {
  ...
  return [
    ...
    "",
    "> A compact, agent-readable knowledge hub and resource wiki led by the Living Atlas for supervised AI-agent work in accounting, audit, controllership, and finance operations.",
    "",
    ...
    "",
    "Use the Living Atlas as the primary map for this knowledge hub and resource wiki. Further benchmark and LedgerBench product development is fully deferred; existing benchmark routes, APIs, stable IDs, schemas, downloads, and reference assets remain available for compatibility and reference.",
    "",
...
export function buildLlmsText() {
  return [
    "# Accounting Agents",
    "",
    "> A public knowledge hub and resource wiki led by the Living Atlas for supervised AI-agent work in accounting, audit, controllership, and finance operations.",
    "",
    "Use the compact context first and start with the Living Atlas as the primary map through this knowledge hub and resource wiki. Retrieve the source catalog only when a task needs standards, guidance, research, or implementation evidence. Source records distinguish rules, official guidance, research papers, technical references, empirical evidence, thought pieces, and first-party practice examples.",
    "",
    "## Context",
    "",
    ...
    `- [Accounting Agent Bench](${siteOrigin}/bench.md): Deferred compatibility/reference asset with thirty public conformance cases and hard authority gates.`,
    `- [Accounting Agent Bench JSON](${siteOrigin}/downloads/accounting-agent-bench.json): Deferred compatibility/reference download for the suite method and case records.`,
    `- [Accounting Agent Bench case schema](${siteOrigin}/schemas/benchmark-case.schema.json): Stable compatibility schema for public case records.`,
    `- [LedgerBench program](${siteOrigin}/ledgerbench.md): Deferred compatibility/reference asset with the retained measurement claim, products, tracks, divisions, task admission, governance, and release plan.`,
    ...
    `- [Benchmark API](${siteOrigin}/api/v1/benchmark): Deferred compatibility/reference API for the existing public conformance cases.`,
    `- [Benchmark case schema](${siteOrigin}/schemas/benchmark-case.schema.json): Stable compatibility schema for public conformance cases.`,
    `- [LedgerBench API](${siteOrigin}/api/v1/ledgerbench): Deferred compatibility/reference API for the retained program record and schema links.`,
    `- [LedgerBench program schema](${siteOrigin}/schemas/ledgerbench-program.schema.json): Stable compatibility schema for the retained program record.`,
    `- [LedgerBench episode schema](${siteOrigin}/schemas/ledgerbench-episode.schema.json): Stable compatibility schema for evaluation episodes.`,
    `- [LedgerBench result schema](${siteOrigin}/schemas/ledgerbench-result.schema.json): Stable compatibility schema for result records.`,
    `- [LedgerBench submission schema](${siteOrigin}/schemas/ledgerbench-submission.schema.json): Stable compatibility schema for submission manifests.`,
    ...
    `- [Accounting Agent Bench](${siteOrigin}/bench): Deferred deterministic conformance/reference asset.`,
    `- [LedgerBench](${siteOrigin}/ledgerbench): Deferred benchmark-program compatibility/reference asset.`,
