...
export const ledgerBenchEpisodeSchema = {
  ...
  required: [
    "schema_version", "episode_id", "benchmark_release", "track", "division",
  ...
  properties: {
    ...
    task_population: {
      ...
      properties: {
        ...
        operating_context: { type: "object", additionalProperties: true },
    ...
    acceptance_model: {
      type: "object",
      additionalProperties: false,
      required: ["mandatory_checks", "review_required", "review_threshold", "hard_gates"],
      properties: {
        mandatory_checks: {
          type: "array",
          minItems: 1,
