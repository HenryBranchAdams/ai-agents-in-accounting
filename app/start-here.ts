  ...
  comparisons: [
    {
      ...
      label: "Chat",
      evidence_classification: "implementation-pattern" as EvidenceClassificationId,
      accounting_example_classification: "synthetic-example" as EvidenceClassificationId,
  ...
  evidence_to_decision_chain: [
    {
      ...
      label: "Evidence",
      evidence_classification: "implementation-pattern" as EvidenceClassificationId,
      application_classification: "synthetic-example" as EvidenceClassificationId,
...
export function renderStartHereMarkdown() {
  ...
  const lines = [
    ...
    "",
    "| Stable ID | Pattern | Pattern classification | Controller | Behavior | Accounting example | Example classification | Boundary |",
    "|---|---|---|---|---|---|---|---|",
    ...lesson.comparisons.map((item) => `| \`${item.id}\` | ${item.label} | ${item.evidence_classification} | ${markdownCell(item.controller)} | ${markdownCell(item.behavior)} | ${markdownCell(item.accounting_example)} | ${item.accounting_example_classification} | ${markdownCell(item.boundary)} |`),
    "",
    "## Governing rule",
    "",
    ...
    "",
    "| Stable ID | Step | Pattern classification | Synthetic lesson application | Application classification | Owner |",
    "|---|---|---|---|---|---|",
    ...lesson.evidence_to_decision_chain.map((item) => `| \`${item.id}\` | ${item.label} | ${item.evidence_classification} | ${markdownCell(item.text)} | ${item.application_classification} | ${markdownCell(item.owner)} |`),
    "",
