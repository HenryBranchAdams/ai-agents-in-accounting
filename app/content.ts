...
export const searchItems = [
  ...
  { href: "/bench", title: "Run the Core conformance suite", category: "Lab", detail: "Deferred compatibility reference with thirty public cases across six synthetic workflow packs" },
  { href: "/ledgerbench", title: "Inspect the LedgerBench research program", category: "Lab", detail: "Deferred compatibility reference for specialist measurement methods, task admission, verification, and governance" },
