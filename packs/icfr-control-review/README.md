...
Validate a review-control population, reproduce the analysis, preserve exceptions, and prepare attributable review evidence.
...
1. Validate population completeness
2. Recalculate the management analysis
3. Apply the approved precision threshold
4. Retain every exception
5. Prepare the review packet

## Required checks

- Population count and value tie to the authoritative source
- Review criteria match the approved control description
- Every threshold breach has evidence and disposition
- The agent does not assert operating effectiveness or certification
