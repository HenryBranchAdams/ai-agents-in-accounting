# Revenue contract and recognition review

Extract contract facts, map them to the approved revenue policy, and prepare a recognition schedule with visible judgments.
...
1. Extract enforceable terms
2. Identify promised goods and services
3. Determine transaction price and allocation
4. Evaluate timing of satisfaction
5. Prepare schedule and issue memo

## Required checks

- Extracted terms trace to contract clauses
- Allocated consideration equals transaction price
- Billing, deferred revenue, and recognized revenue reconcile
- Material judgments remain assigned to a reviewer
