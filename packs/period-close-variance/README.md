# Period close and variance review

Track close dependencies, reproduce control totals, and explain material movements without certifying the close.

Pack ID: `period-close-variance`  
Version: 1.0.0  
...
1. Validate checklist scope and dependencies
2. Reproduce trial-balance totals
3. Calculate account movements
4. Trace explanations to evidence
5. Escalate unresolved or late items

## Required checks

- Trial-balance debits equal credits
- All required close tasks have an attributable state
- Variance calculations reproduce
- Every material explanation links to evidence
